...
public class GarbageFirebase {
    ...
    public static void listenAndNotify(String uid) {
        userssRef.child(uid).child("garbage").addValueEventListener(new GarbageValueEventListener());
    }

    @DebugLog
    private static class GarbageValueEventListener implements ValueEventListener {
